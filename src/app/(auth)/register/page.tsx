...
import {EyeIcon as Eye, EyeClosed} from "lucide-react";
...
export default function Register() {
    ...
    const [icon, setIcon] = useState<JSX.Element>(EyeClosed);
            ...
            <div className="w-full sm:w-96 p-8 bg-white shadow-lg rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className={'relative'}>
                        ...
                        />
                        <Icon className={"absolute right-3 top-[55%] "} onClick={()=>handleShowPassword()}/>
                    </div>
