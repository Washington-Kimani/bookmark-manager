          ...
          <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <form onSubmit={handleProfileUpdate} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#26425A] hover:bg-[#3A5A7F] text-white font-semibold py-2 px-4 rounded-md transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
                <Save size={18} />
